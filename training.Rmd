...
En esta notebook se introduce el uso de los datos de [InfluScience 2](https://ranking.influscience.eu/estadisticas-y-datos/), incluyendo varios estudios de caso para facilitar el trabajo con este dataset.
